...
namespace Demo
{
    ...
    public class Funcionario : Pessoa
    {
        ...
        {
            Nome = string.IsNullOrEmpty(nome) ? "Fulano" : nome; // caso nome esteja vazio ele testa com o nome Fulano
        ...
        {
            if (salario < 500) throw new Exception(message: "Salário inferior ao permitido");

            Salario = salario;

            if (salario >= 500 && salario < 2000) NivelProfissional = NivelProfissional.Junior;
        ...
        private void DefinirHabilidades()
        {
            ...
            switch (NivelProfissional)
            {
                case NivelProfissional.Pleno:
                    Habilidades.Add(item: "Testes");
                    break;
                case NivelProfissional.Senior:
                    Habilidades.Add(item: "Testes");
                    Habilidades.Add(item: "Microservices");
                    break;
            }
        }
    }
