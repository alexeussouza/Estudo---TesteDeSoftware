...
{
    [AttributeUsage(AttributeTargets.Method)]  // atributo usado para Metodos
    public class TestPriorityAttribute : Attribute
    {
        public TestPriorityAttribute(int priority) // Ordena testes pela prioridade
        {
            Priority = priority;
        }
    ...
    public class PriorityOrderer : ITestCaseOrderer  // interface que organiza a ordem que serão executados os testes
    {
